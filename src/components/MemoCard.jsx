	...
	return (
	  ...
	  >
		...
		>
		  ...
		  {/* Back */}
		  <div className="absolute w-full h-full backface-hidden bg-gradient-to-br from-[#7898d2] to-[#a0c8ed] rounded-md shadow-[5px_5px_10px_rgba(0,0,0,0.5)] flex justify-center items-center 
						  text-4xl rotate-y-180">
			{memoCard.icon}
		  </div>
		</div>
	  </div>
